...
public class CashierMenuUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CashierMenuUI frame = new CashierMenuUI();
	...
	public CashierMenuUI() {
		...
		JMenu mnNewMenu = new JMenu("Manage Accounts");
		mnNewMenu.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				CashierMenuAccountUI cui =new CashierMenuAccountUI();
				contentPane.add(cui);
				cui.setVisible(true);
		...
		mnNewMenu_4.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				CashierLoginUI cui =new CashierLoginUI();
				cui.setVisible(true);
				dispose();
			}
		});
