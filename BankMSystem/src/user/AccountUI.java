...
public class AccountUI extends JInternalFrame {
	...
	public AccountUI() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(checkValidation()) {
					...
					String accountType=cmbacctype.getSelectedItem().toString();
					...
					boolean added=acDB.add(a);
					if(added) {					
						JOptionPane.showMessageDialog(getContentPane(), "Account is added");
					}else {
						JOptionPane.showMessageDialog(getContentPane(), "Account is not added");
					}
				}
			}
		});
		...
		btnNewButton.setBounds(456, 267, 129, 49);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(checkValidation()) {
					...
					if(updated) {					
						JOptionPane.showMessageDialog(getContentPane(), "Account is updated");
					}else {
						JOptionPane.showMessageDialog(getContentPane(), "Account is not updated");
					}
				}
			}
		});
		...
		btnNewButton_1.setBounds(185, 354, 129, 49);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int accountID=Integer.valueOf(JOptionPane.showInputDialog(getContentPane(), "Enter the Account ID"));
				boolean deleted=acDB.delete(accountID);
				if(deleted) {
					JOptionPane.showMessageDialog(getContentPane(), "The Account is deleted");
				}else {
					JOptionPane.showMessageDialog(getContentPane(), "The Account is not deleted");
				}
			}
		});
		btnNewButton_2.setVerticalAlignment(SwingConstants.BOTTOM);
		btnNewButton_2.setFont(new Font("Yu Gothic Medium", Font.BOLD, 17));
		btnNewButton_2.setBounds(356, 354, 129, 49);
		...
		btnGetall.setBounds(530, 354, 129, 49);
